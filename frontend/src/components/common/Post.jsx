...
console.log(post);
  ...
  return (
    <>
      <div className="flex gap-2 items-start p-4 border-b border-gray-700 shadow-[0_3px_10px_rgb(0,0,0,0.2)] m-3 mt-8">
        <div className="avatar">
          <Link
            to={`/profile/${postOwner.username}`}
            className="w-8 rounded-full overflow-hidden"
          >
            <img src={postOwner.profileImg || "/boy2.png"} />
          </Link>
        </div>
          ...
          <div className="flex flex-col gap-3 overflow-hidden">
            <span>{post.text}</span>
             {post.img && (
              <img
                src={post.img}
                className=" h-90 md:h-110 object-contain rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] mx-0 md:mx-4 my-4 mr-4"
                alt=""
              />
            )}
            {post.media &&
              (post.media.endsWith(".mp4") || post.media.includes("video") ? (
                ...
                <img
                  src={post.media}
                  className="h-110 object-contain rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] mx-0 md:mx-4 my-4 mr-4"
                  alt=""
                />
              ))}
          </div>
